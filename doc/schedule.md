...
### WEEK 2（国庆）
#### To guiguisocute
- [x] 实现红砖的消失效果与按钮的绑定（隐藏门？状态机过渡？idk……）
- [x] 或许能想一想怎么使tile组实现“吸附”的效果？
- [x] ……
- [x] guiguisocute留：事情太多了等我解决完贫困生的事，国庆节我一定把架构全理清楚，然后设法分法活给你们 ~~（flag）~~
#### To LIEKA
#### YiWang514
#### To ZYF
...
### WEEK 4(校运会)
#### To guiguisocute
- [x] 懒鬼了这么久，赶紧推，赶紧推啊！！！！，地基不打好，怎么对得起要带的队友们，怎么让你的中期报告写出来
- [x] 重构项目为更合理的文件布局
- [x] 重构项目为统一审美的1080p布局 ~~（去免费的网站里偷点好看的）~~
- [x] 写好符合level1要求的人物状态机，export的横竖轴变量要是步长方便debug
- [x] 写好符合level1的关卡状态机，至少要到掉下去和碰到黑厄会死（正好有尖刺对的素材），碰到祭坛会赢的程度
#### To LIEKA
- [x] 等guigui写完上述功能后开工
- [x] 写die的状态（动画躺下，然后强制暂停游戏重开，就跟原版黄金替罪羊差不多就行）

#### To Yiwang514
- [x] 等guigui写完上述功能后开工
- [x] 搭建level1，同时和归归一起思考一下按钮该如何实现。

#### To ZYF
- [x] 找点合适的祭坛按钮tile素材，也可一起参与讨论程序
