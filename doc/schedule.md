...
- [ ] 写好符合level1要求的人物状态机，export的横竖轴变量要是步长方便debug
- [ ] 写好符合level1的关卡状态机，至少要到掉下去和碰到黑厄会死（正好有尖刺对的素材），碰到祭坛会赢的程度
#### To LIEKA
- [ ] 等guigui写完上述功能后开工
- [ ] 写die的状态（动画躺下，然后强制暂停游戏重开，就跟原版黄金替罪羊差不多就行）

#### To Yiwang514
- [ ] 等guigui写完上述功能后开工
- [ ] 搭建level1，同时和归归一起思考一下按钮该如何实现。

#### To ZYF
- [ ] 找点合适的祭坛按钮tile素材，也可一起参与讨论程序
